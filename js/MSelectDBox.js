	...
	(function($){
		...
		MSelectDBox.prototype = {
			...
			"applySelectedToList" : function(list){
				...
				for (var c in list) {
					if (!Object.prototype.hasOwnProperty.call(list, c)) continue;
					if (!list[c]) continue;
			...
			_selectByValue: function(value, reset) {
				...
				for (c=0; c<value.length; c++) {
					if (!Object.prototype.hasOwnProperty.call(valuesCache, value[c])) continue;
			...
			_selectByLabel: function(label, reset) {
				...
				for (c=0; c<label.length; c++) {
					if (!Object.prototype.hasOwnProperty.call(labelsCache, label[c])) continue;
			...
			"fx" : {
				...
				"hop": function(obj, prop) {
					return Object.prototype.hasOwnProperty.call(prop, prop)
				}
			}
		};
